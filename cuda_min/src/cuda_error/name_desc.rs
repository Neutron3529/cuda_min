pub fn get_name_desc(code: std::ffi::c_int) -> (&'static str, &'static str) {
    match code {
        ...
        19 => (
            ...
            "texture is not bound to a pointer",
        ),
        20 => (
        ...
        27 => (
            ...
            "read as normalized float not supported for data type",
        ),
        28 => (
        ...
        65 => (
            ...
            "launch would exceed maximum depth of nested launches",
        ),
        66 => (
            "cudaErrorLaunchFileScopedTex",
            "launch failed because kernel uses unsupported, file-scoped textures (texture objects are supported)",
        ),
        67 => (
            "cudaErrorLaunchFileScopedSurf",
            "launch failed because kernel uses unsupported, file-scoped surfaces (surface objects are supported)",
        ),
        68 => (
